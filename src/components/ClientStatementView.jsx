          ...
          <div ref={printRef} className="print-area" style={{ background: "#ffffff", color: "#0F172A", width: "100%", maxWidth: "850px", minHeight: "1050px", padding: "24px 28px", fontFamily: "'Calibri', 'Inter', sans-serif", display: "flex", flexDirection: "column", justifyContent: "space-between", boxSizing: "border-box", boxShadow: "0 10px 30px rgba(0,0,0,0.35)", borderRadius: 4 }}>
            <div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "2px solid #0F172A", paddingBottom: 10, marginBottom: 12 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 10.5, color: "#475569", fontWeight: 600 }}>Financial Management &amp; Client Accounts Receivable Sub-Ledger</div>
                  </div>
                </div>
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: 14, fontWeight: 800, color: "#0284C7", textTransform: "uppercase", letterSpacing: "0.5px" }}>CLIENT STATEMENT</div>
                  <div className="mono" style={{ fontSize: 11, fontWeight: 700, color: "#0F172A" }}>STMT-{(client.clientCode || client.id || "").toUpperCase()}</div>
                </div>
              </div>
              ...
              <div style={{ background: "#F8FAFC", border: "1px solid #000000", borderRadius: 5, padding: "8px 12px", marginBottom: 12, display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 10, fontSize: 10.5 }}>
                <div>
                  <div style={{ marginBottom: 3 }}><b>Client Account:</b> <span style={{ fontWeight: 700, fontSize: 11.5, color: "#0F172A" }}>{client.companyName || client.name}</span> <span style={{ color: "#64748B" }}>({client.clientCode || client.id})</span></div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, marginBottom: 10 }}>
                ...
                <div style={{ background: "#E0F2FE", padding: "6px 10px", borderRadius: 4, border: "1.5px solid #0284C7", textAlign: "center" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 12, fontSize: 9, tableLayout: "fixed" }}>
                  ...
                  {statementData.rows.length === 0 ? (
                    ...
                    statementData.rows.map((row, idx) => (
                      <tr key={idx}>
                        ...
                        <td style={{ border: "1px solid #000", padding: "4px 3px", textAlign: "center", fontWeight: 600, fontSize: 8.5, color: row.type === "Invoice" ? "#0284C7" : "#059669" }}>
                          {row.type}
                        </td>
                        <td style={{ border: "1px solid #000", padding: "4px 5px", wordBreak: "break-word", fontSize: 8.8 }}>
                          ...
                          {row.taxBreakdown && row.taxBreakdown.kind === "invoice" && (
                            <div style={{ fontSize: 7.5, color: "#475569", marginTop: 2, lineHeight: 1.2 }}>
                        ...
                        <td style={{ border: "1px solid #000", padding: "4px 3px", textAlign: "right", color: row.debit > 0 ? "#0284C7" : "inherit", fontSize: 8.8, fontWeight: row.debit > 0 ? 700 : 400 }}>
                          {row.debit > 0 ? pkr(row.debit) : "—"}
                        </td>
                        <td style={{ border: "1px solid #000", padding: "4px 3px", textAlign: "right", color: row.credit > 0 ? "#059669" : "inherit", fontSize: 8.8, fontWeight: row.credit > 0 ? 700 : 400 }}>
                          {row.credit > 0 ? pkr(row.credit) : "—"}
                        </td>
                        <td style={{ border: "1px solid #000", padding: "4px 3px", textAlign: "right", fontWeight: 800, color: row.runningBalance > 0 ? "#0284C7" : "#059669", fontSize: 9 }}>
                ...
                <tfoot>
                  <tr style={{ background: "#F1F5F9", fontWeight: 800 }}>
                    ...
                    <td style={{ border: "1px solid #000", padding: "5px 3px", textAlign: "right", color: "#0284C7", fontSize: 8.8 }}>{pkr(statementData.totalInvoiced)}</td>
                    <td style={{ border: "1px solid #000", padding: "5px 3px", textAlign: "right", color: "#059669", fontSize: 8.8 }}>{pkr(statementData.totalReceived)}</td>
                    <td style={{ border: "1px solid #000", padding: "5px 3px", textAlign: "right", color: "#0369A1", fontSize: 9.2 }}>{pkr(statementData.closingBalance)}</td>
                  </tr>
                </tfoot>
              </table>
