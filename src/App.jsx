              ...
              <tbody>
                {doc.oohSites && doc.oohSites.length > 0 ? (
                  doc.oohSites.map((site, idx) => {
                    ...
                    const cellBase = { border: "1px solid #000000", padding: "7px 2px", boxSizing: "border-box", verticalAlign: "middle", fontSize: 8, whiteSpace: "nowrap" };
                    return (
                      <tr key={idx} style={{ minHeight: 34 }}>
                        ...
                        <td style={{ ...cellBase, textAlign: "center", fontWeight: 600, fontSize: 7.5 }}>{w.toFixed(0)} × {h.toFixed(0)} ft</td>
                        ...
                        <td style={{ ...cellBase, textAlign: "center", fontWeight: 600, fontSize: 7.5 }}>{fmtDocDate(site.fromDate)}</td>
                        <td style={{ ...cellBase, textAlign: "center", fontWeight: 600, fontSize: 7.5 }}>{fmtDocDate(site.toDate)}</td>
                  ...
                  <tr>
                    <td style={{ border: "1px solid #000000", padding: "7px 2px", textAlign: "center", fontWeight: 700, boxSizing: "border-box", verticalAlign: "middle", fontSize: 8, whiteSpace: "nowrap" }}>1</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 6px", textAlign: "left", fontWeight: 600, wordBreak: "break-word", boxSizing: "border-box", verticalAlign: "middle", fontSize: 8 }}>
                      {doc.location || "Shahrah-e-Faisal Billboard Site"}
                    </td>
                    <td style={{ border: "1px solid #000000", padding: "7px 2px", textAlign: "center", fontWeight: 600, boxSizing: "border-box", verticalAlign: "middle", fontSize: 7.5, whiteSpace: "nowrap" }}>20 × 10 ft</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 2px", textAlign: "center", fontWeight: 700, boxSizing: "border-box", verticalAlign: "middle", fontSize: 8, whiteSpace: "nowrap" }}>200</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 2px", textAlign: "center", fontWeight: 600, boxSizing: "border-box", verticalAlign: "middle", fontSize: 7.5, whiteSpace: "nowrap" }}>—</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 2px", textAlign: "center", fontWeight: 600, boxSizing: "border-box", verticalAlign: "middle", fontSize: 7.5, whiteSpace: "nowrap" }}>—</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 2px", textAlign: "center", fontWeight: 600, boxSizing: "border-box", verticalAlign: "middle", fontSize: 8, whiteSpace: "nowrap" }}>30</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 5px", textAlign: "right", boxSizing: "border-box", verticalAlign: "middle", fontSize: 8, whiteSpace: "nowrap" }}>{pkr(netAmt)}</td>
                    <td style={{ border: "1px solid #000000", padding: "7px 5px", textAlign: "right", fontWeight: 700, boxSizing: "border-box", verticalAlign: "middle", fontSize: 8, whiteSpace: "nowrap" }}>{pkr(netAmt)}</td>
                  </tr>
                )}
                <tr style={{ fontWeight: 800, background: "#F8FAFC" }}>
                  <td colSpan={3} style={{ border: "1px solid #000000", padding: "6px 8px", textAlign: "right", fontSize: 8, fontWeight: 700 }}>
                    TOTAL CAMPAIGN SQ.FT:
                  </td>
                  <td style={{ border: "1px solid #000000", padding: "6px 2px", textAlign: "center", fontWeight: 800, fontSize: 8, color: "#0284C7", whiteSpace: "nowrap" }}>
                  ...
                  <td colSpan={4} style={{ border: "1px solid #000000", padding: "6px 8px", textAlign: "right", fontSize: 8, fontWeight: 700, color: "#334155" }}>
                    TOTAL NET AMOUNT:
                  </td>
                  <td style={{ border: "1px solid #000000", padding: "6px 5px", textAlign: "right", color: "#0F172A", fontWeight: 800, fontSize: 8.5, whiteSpace: "nowrap" }}>
                    {pkr(netAmt)}
                  </td>
                </tr>
                {renderTotals(8)}
